...
public class Main extends ImageJFrame implements Runnable , ActionListener {
	...
	ImageButton shellsortBT = new ImageButton("image/shellsortBT.jpg"); ;
	...
	public Main() {
		...
		shellsortBT.addActionListener(this);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == resetButton) {
			...
			try {
				...
				try {
					ShellSort shellTmp = (ShellSort)(nowMainContent);
					shellSort = new ShellSort("image/mainContent.jpg");
					shellSort.init(10);
					shellSort.setLocation(0, 0);
					add(shellSort);
					nowMainContent = shellSort;
				}
				catch(Exception e3) {
		...
		if(e.getSource()==shellsortBT) {
			...
			add(shellSort);
			nowMainContent = shellSort;
			shellsortBT.setImage("image/shellsort1.jpg");
			hanoiBT.setImage("image/HanoiBtn.jpg");
